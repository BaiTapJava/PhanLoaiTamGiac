...
public class PhanLoaiTamGiacTest {
    ...
    void testTriangle1(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(2,2,2);
    ...
    void testTriangle2(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(2,2,3);
        assertEquals(expected,result);
    }
    ...
    void testTriangle3(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(3,4,5);
        assertEquals(expected,result);
    }
    ...
    void testTriangle4(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(8,2,3);
        assertEquals(expected,result);
    }
    ...
    void testTriangle5(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(-1,2,1);
        assertEquals(expected,result);
    }
    ...
    void testTriangle6(){
        ...
        String result = PhanLoaiTamGiac.PhanLoaiTamGiacTest(0,1,1);
        assertEquals(expected,result);
    }
}
